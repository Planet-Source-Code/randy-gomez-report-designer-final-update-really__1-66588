...
'////////////////////////////////////////////////////////
'///              Image List Support Module
'///                 (modImageList.bas)
'///_____________________________________________________
'/// Sopport module for Image List Class.
'///_____________________________________________________
...
Declare Function DrawText Lib "user32" Alias "DrawTextA" (ByVal hDC As Long, ByVal lpStr As String, ByVal nCount As Long, lpRect As RECT, ByVal wFormat As Long) As Long
    ...
    Public Const DT_END_ELIPSE = &H8000
Type DRAWTEXTPARAMS
    cbSize As Long
    iTabLength As Long
    iLeftMargin As Long
...
Public Declare Function ImageList_GetImageInfo Lib "COMCTL32.DLL" ( _
        ByVal hIml As Long, ByVal i As Long, pImageInfo As IMAGEINFO) As Long
...
Public Declare Function ImageList_Draw Lib "COMCTL32.DLL" ( _
        ...
        ByVal X As Long, ByVal Y As Long, ByVal fStyle As Long) As Long
...
Public Declare Function ImageList_GetImageRect Lib "COMCTL32.DLL" ( _
        ByVal hIml As Long, ByVal i As Long, prcImage As RECT) As Long
' Messages:
